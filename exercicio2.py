...
idx_max = df_rio.groupby("ANO-MES")["PREÇO MÉDIO REVENDA"].idxmax()
#print(idx_max)
#ANO-MES
#2004-05     24154
#2004-06     24316
...
#2021-03    119852
#2021-04    120387
#Name: PREÇO MÉDIO REVENDA, Length: 203, dtype: int64

idx_min = df_rio.groupby("ANO-MES")["PREÇO MÉDIO REVENDA"].idxmin()
#print(idx_min)
#ANO-MES
#2004-05        49
#2004-06     36296
...
df_diff["min"] = df_min
#print(df_diff)
 #        abs_diff  percent_diff     max    min
#ANO-MES
#2004-05    28.062   2569.780220  29.154  1.092
#2004-06    28.138   2558.000000  29.238  1.100
#2004-07    28.242   2562.794918  29.344  1.102
#2004-08    28.262   2566.939146  29.363  1.101
#2004-09    28.034   2539.311594  29.138  1.104
#...           ...           ...     ...    ...
#2020-12    64.203   2135.118058  67.210  3.007
#2021-01    67.192   2221.223140  70.217  3.025
#2021-02    67.991   2234.341111  71.034  3.043
#2021-03    71.483   2312.617276  74.574  3.091
#2021-04    73.836   2452.208569  76.847  3.011
